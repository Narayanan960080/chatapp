...
class FadeAnimation extends StatelessWidget {
  ...
  FadeAnimation({required this.delay, required  this.child, required this.isTopToBottom});

  @override
  Widget build(BuildContext context) {
    final tween = MultiTween<AniProps>()
      ..add(AniProps.opacity, 0.0.tweenTo(1.0), 500.milliseconds)
      ..add(AniProps.translateY, (isTopToBottom ? -30.0 : 0.0).tweenTo(isTopToBottom ? 0.0 : -1.0), 500.milliseconds,
          Curves.easeOut);
